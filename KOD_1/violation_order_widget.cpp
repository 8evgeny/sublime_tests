...
//Конструктор класса ViolationOrderWidget наследуется от QWidget
ViolationOrderWidget::ViolationOrderWidget(QWidget* parent) : QWidget(parent) {

//Создается db - объект базы даных
    QSqlDatabase db = QSqlDatabase::addDatabase("QPSQL");

//Создается settings - объект настроек из ini файла
    QSettings settings(kSettingsFile, QSettings::IniFormat);

//Параметры - если нет ключа - принимается значение по умолчанию
...
//Широту и долготу пишем в _violation_order
    ...
    settings.endGroup();
//Конец конструктора класса  ViolationOrderWidget
}


//Реализация метода Init() класса ViolationOrderWidget
void ViolationOrderWidget::Init() {

//Создается новый объект - главное окно с вертикальным размещением элементов
  auto main_layout = new QVBoxLayout;
//мин ширина
  setMinimumWidth(kMinWidthMainlayout);
//Устанавливается в качестве рабочего окна
  setLayout(main_layout);


  {
//При нажатии кнопки вызывается метод SelectFilePath
...
//Выравнивание размещения элементов
...
//Конец реализации метода Init() класса ViolationOrderWidget
}


//Реализация метода SetDispatcher() класса ViolationOrderWidget
void ViolationOrderWidget::SetDispatcher(Dispatcher* dispatcher) {
  _dispatcher = dispatcher;
}

//Реализация метода Send() класса ViolationOrderWidget
...
//Конец реализации метода Send() класса ViolationOrderWidget
}

//Реализация метода SelectFilePath() класса ViolationOrderWidget
...
//Реализация метода DirSelected класса ViolationOrderWidget
...
//На основании регулярки вытаскиваем
...
//Конец реализации метода DirSelected класса ViolationOrderWidget
}


//Реализация метода SaveInDataBase класса ViolationOrderWidget
