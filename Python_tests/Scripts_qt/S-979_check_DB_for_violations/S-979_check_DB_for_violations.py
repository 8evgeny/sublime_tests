...
try:
    ...
    interval = input()
    if interval == "1":
        t0 = time - timedelta(weeks=52)
    elif interval == "2":
        t0 = time - timedelta(days=90)
    elif interval == "3":
        t0 = time - timedelta(days=30)
    elif interval == "4":
        t0 = time - timedelta(weeks=1)
    elif interval == "5":
        ...
        t0 = time - timedelta(weeks=1000)
# t0 = time - timedelta(days=0, seconds=0, microseconds=0,
# milliseconds=0, minutes=0, hours=0, weeks=1000)
    ...
    for code in codes_in_DB:
        count_violations = "SELECT count(*) FROM violation_order "\
