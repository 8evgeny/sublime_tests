#ifndef RTP_CLIENT_H265_HPP
#define RTP_CLIENT_H265_HPP
...
#include "rtp_client_h265_settings.hpp"
...
{
public:
    RtpClientH265(client::h265::SettingsPtr &settings);
    bool setup();
    bool start();
    bool stop();
    bool is_execute();
...
private:
    friend void newData(GstElement *appsrc, RtpClientH265 *client);
    void workflow();

    std::string enc_type = "h265";
    ...
    client::h265::SettingsPtr settings;
    ...
    ///meta data in header
    GstPad *rtph265depay_sink_pad = nullptr;
