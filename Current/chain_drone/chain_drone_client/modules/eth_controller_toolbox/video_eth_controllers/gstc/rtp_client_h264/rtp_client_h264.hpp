...
#include "rtp_client_h264_settings.hpp"
...
{
public:
    RtpClientH264(client::h264::SettingsPtr &settings);
    bool setup();
    bool start();
    bool stop();
    bool is_execute();
...
private:
    friend void newData(GstElement *appsrc, RtpClientH264 *client);
    void workflow();
    ...
    client::h264::SettingsPtr settings;
