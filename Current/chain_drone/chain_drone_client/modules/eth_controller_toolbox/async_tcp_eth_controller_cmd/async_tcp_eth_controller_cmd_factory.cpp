...
namespace eth_controller::cmd::async
{
    ...
    std::shared_ptr<AsyncTcpEthControllerCmd> create(const std::string &path2ini, const std::string &sectionName)
    {
        ...
        server_settings.dst_ip_v4 = settings.dst_ip_v4;
        server_settings.dst_port = settings.dst_port;
        ...
        client_settings.src_ip_v4 = settings.src_ip_v4;
        client_settings.src_port = settings.src_port;
