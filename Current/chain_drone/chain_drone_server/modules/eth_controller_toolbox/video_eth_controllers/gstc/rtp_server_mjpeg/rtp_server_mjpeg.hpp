#ifndef RTP_SERVER_MJPEG_HPP
#define RTP_SERVER_MJPEG_HPP
...
#include "rtp_server_mjpeg_settings.hpp"
#include <chrono>
...
class RtpServerMJPEG
{
public:
    RtpServerMJPEG(rtp::server::mjpeg::SettingsPtr &settings_ext);
    bool setup();
    bool start();
    bool stop();
...
private:
    friend void waitData(GstElement *appsrc, guint unused, RtpServerMJPEG *server);
    void workflow();
    ...
    GstBus *bus;
    GstMessage *msg;
    server::mjpeg::SettingsPtr settings;
