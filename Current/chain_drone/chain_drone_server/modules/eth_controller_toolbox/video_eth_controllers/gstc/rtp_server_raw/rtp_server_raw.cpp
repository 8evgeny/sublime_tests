...
static void setAppSrcSettings(GstElement *appsrc,
                              const server::raw::VideoSettings &settings)
{
...
static void setRtpPaySettings(GstElement *rtppay,
                              const server::raw::PaySettings &settings)
{
...
static void setUdpSettings(GstElement *udpsink,
                           const server::raw::UdpSettings &settings)
{
...
static void setEncoderSettings(GstElement *encoder,
                               const server::raw::EncoderSettings &settings)
{
...
RtpServerH264::RtpServerH264(server::raw::SettingsPtr &settings_ext) //: settings(settings)
{
