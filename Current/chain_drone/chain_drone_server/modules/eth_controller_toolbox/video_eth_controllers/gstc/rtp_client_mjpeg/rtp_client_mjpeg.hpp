#ifndef RTP_CLIENT_MJPEG_HPP
#define RTP_CLIENT_MJPEG_HPP
...
#include "rtp_client_mjpeg_settings.hpp"

namespace rtp
{
class RtpClientMJPEG
{
public:
    RtpClientMJPEG(client::mjpeg::SettingsPtr &settings);
    bool setup();
    bool start();
    bool stop();
    bool is_execute();
...
private:
    friend void newData(GstElement *appsrc, RtpClientMJPEG *client);
    void workflow();
    ...
    client::mjpeg::SettingsPtr settings;
