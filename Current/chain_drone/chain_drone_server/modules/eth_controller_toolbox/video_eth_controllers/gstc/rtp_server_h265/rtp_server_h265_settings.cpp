                    ...
                    Settings &settings)
{
    ...
    /// NVVIDEOCONV
    parse_ini_report &= ini_reader_tool::GetInteger(reader, ini_section_name, "conv_width", settings.video.width);
    parse_ini_report &= ini_reader_tool::GetInteger(reader, ini_section_name, "conv_height", settings.video.height);
