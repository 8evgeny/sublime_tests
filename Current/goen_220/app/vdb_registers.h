...
typedef enum {
    ...
    en_vdb_host_detector_target = 0x02
} t_host_registers;
...
typedef enum {
    ...
    en_vdb_fb_telemtry               = 0x10,
    en_vdb_fb_fibre_channel          = 0x20,
    en_vdb_fb_flash                  = 0x30,
    en_vdb_fb_video_correction       = 0x40,
    en_vdb_fb_gsp_controller         = 0x50,
    en_vdb_fb_tracking               = 0x70,
    en_vdb_fb_video_streams_control  = 0x80,
    en_vbd_fb_service_msg            = 0xff
...
typedef enum {
    ...
    en_vdb_mb_telemtry               = 0x10,
    en_vdb_mb_autofocus              = 0x20,
    en_vdb_mb_field_sync             = 0x30,
    en_vdb_mb_serdes                 = 0x40,
    en_vdb_mb_stream_mem_bridge      = 0x50,
    en_vdb_mb_stream_mux             = 0x60,
    en_vdb_mb_video_statistics       = 0x70,
    en_vdb_mb_navigation             = 0x80,
...
typedef enum {
    ...
    en_vdb_mw_sensor_dde_detail_gain            = 0x32,
    en_vdb_mw_sensor_dde_detail_eps_normal      = 0x33,
    en_vdb_mw_sensor_dde_hist_background_thrld  = 0x34,
    en_vdb_mw_sensor_dde_brightness             = 0x35,
    en_vdb_mw_sensor_dde_alpha_addr             = 0x36,
    en_vdb_mw_sensor_dde_contrast               = 0x37,
    en_vdb_mw_sensor_dde_video_inversion        = 0x38,
    // SNR
    ...
    en_vdb_mw_sensor_nuc_lens_position            = 0x66,
    // telemetry
    en_vdb_mw_sensor_tel_status      = 0x70,
    en_vdb_mw_sensor_tel_temperature = 0x71,
    // BPR
    en_vdb_mw_sensor_bpr_enable    = 0x90,
    en_vdb_mw_sensor_bpr_threshold = 0x91,
    // other
...
typedef enum {
    en_vdb_mbmb_mw_vertical_sync_fushion = en_vdb_mb_stream_mem_bridge,
    en_vdb_mbmb_en_test_gen_enable,
    en_vdb_mbmb_en_line_pause_tv,
    en_vdb_mbmb_en_line_pause_sw,
    en_vdb_mbmb_en_line_pause_mw
