...
#include "../../../../../../../src/lib/gsp/Goen220Vdb/src/NCore/CDelimiterWithLenAndCrcMessageParser.h"
...
struct qt_meta_stringdata_CLASSCDelimiterWithLenAndCrcMessageParserENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSCDelimiterWithLenAndCrcMessageParserENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSCDelimiterWithLenAndCrcMessageParserENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject CDelimiterWithLenAndCrcMessageParser::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSCDelimiterWithLenAndCrcMessageParserENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSCDelimiterWithLenAndCrcMessageParserENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCDelimiterWithLenAndCrcMessageParserENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *CDelimiterWithLenAndCrcMessageParser::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSCDelimiterWithLenAndCrcMessageParserENDCLASS.stringdata0))
