...
#include "../../../../../src/app/j200/lens_j200.h"
...
struct qt_meta_stringdata_CLASSLensJ200ENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSLensJ200ENDCLASS = QtMocHelpers::stringData(
    "LensJ200",
    "sendResponse",
    "",
    "isOk"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSLensJ200ENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject LensJ200::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSLensJ200ENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSLensJ200ENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSLensJ200ENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *LensJ200::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSLensJ200ENDCLASS.stringdata0))
