...
IMX477SquareCamMIPI::IMX477SquareCamMIPI(const devices::imx477_square_camera_mipi::UserSettings &settings) : settings(settings)
{

} // -- IMX477SquareCamMIPI::IMX477SquareCamMIPI
...
void IMX477SquareCamMIPI::setup()
{    
...
} // -- END IMX477SquareCamMIPI::setup()

void IMX477SquareCamMIPI::start()
{
    ...
    std::cout << "IMX477SquareCamMIPI::start() -- Pipeline success create!\n";

    std::thread(&IMX477SquareCamMIPI::exec, this).detach(); // поток извлечения кадров из pipeline
} // -- END IMX477SquareCamMIPI::start()

void IMX477SquareCamMIPI::exec()
{
    ...
    */
    ...
    {
        std::cout << "ERROR: IMX477SquareCamMIPI square_crop_sz > video.width || video.height, use default settings" << std::endl;
...
} // -- END IMX477SquareCamMIPI::exec()

void IMX477SquareCamMIPI::quit()
{
    if(sync.quit_was_call.load())
    {
        return;
    }
    std::cout << "TRY close IMX477SquareCamMIPI" << std::endl;
    ...
    while(!sync.exec_complete.load())
    {
        ...
        {
            std::cout << "FORCE quit IMX477SquareCamMIPI" << std::endl;
            gst_cap.release();
            break;
        }
    }
    std::cout << "SUCCESS close IMX477SquareCamMIPI" << std::endl;
    
    // std::cout << "IMX477SquareCamMIPI::quit() -- gst pipeline success closed\n";
} // -- IMX477SquareCamMIPI::quit()

// uint8_t* IMX477SquareCamMIPI::receiveFrame(int &w, int &h, int &id, int &num)
// {
...
{
    return false;
} // -- END IMX477SquareCamMIPI::isBayerColorChannel()

void IMX477SquareCamMIPI::keyHandler(uchar &key)
{

} // -- END IMX477SquareCamMIPI::keyHandler(char &key)

void IMX477SquareCamMIPI::workflow()
{

} // -- END IMX477SquareCamMIPI::workflow()

int IMX477SquareCamMIPI::getColorChannels()
{
#if defined(CCM_8UC1)
    return 1;
#elif defined(CCM_8UC3)
    ...
    return 0;
#endif
} // -- END IMX477SquareCamMIPI::getColorChannels()
