...
#define KERNEL_FILE "tmml_float.cl"
#ifdef SQDIFF_NORMED
...
class tmml_cl
{
  ...
  private:
    ...
    std::string programm_CL_float  //  \n ->  \\n"\n"
    {
        ...
        "\n"
        "__kernel void work_cl_2(__global unsigned char * img_work, __global unsigned char * img_temp, __global float* matchData )\n"
        "{\n"
        ...
        "\n"
        "__kernel void work_cl_6(__global unsigned char * img_work, __global unsigned char * img_temp, __global float* matchData )\n"
        "{\n"
        "    int result_x = get_global_id(0);\n"
        "    int result_y = get_global_id(1);\n"
        "    int iGID = (result_y * RESULT_HEIGHT  + result_x);\n"
