...
UserSettings devices::shared_memory::readSettings(const std::string &pathToSettings, bool &success)
{
...
std::shared_ptr<SharedMemory> devices::shared_memory::create(const std::string &config_path)
{
