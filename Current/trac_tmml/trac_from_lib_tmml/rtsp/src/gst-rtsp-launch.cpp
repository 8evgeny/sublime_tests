...
int main(int argc, char** argv) {
    ...
    "v4l2src device=/dev/video42 io-mode=dmabuf ! video/x-raw, width=1920, height=1080, framerate=30/1 ! "
    "videoconvert ! mpph264enc min-force-key-unit-interval=10 ! rtph264pay name=pay0 pt=96 )"
    );
