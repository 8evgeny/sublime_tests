...
// bool vtrackDataSender::deserialize(vtrackDataStruct & data)
// {
// //    cout << "\nSTART deserialize\n";
//     int pos = 0;
//     ///dbg::
//     memcpy(&data.size, cmd_buffer, sizeof(int));
//     pos += sizeof(int);
...
//         ///dbg::
//         trackPos dbg_pos;
// //        memcpy(&dbg_pos, buffer + pos, sizeof(trackPos));
//         data.v_track[i] = *(reinterpret_cast<trackPos const *>(cmd_buffer + pos));
// //        cout << "dbg:: deserialize res[" << i << "]:" << data.v_track[i].x << " " << data.v_track[i].y << " " << data.v_track[i].w << " " << data.v_track[i].h << endl;
//         pos += sizeof(trackPos);
//     }

//     cout << "END deserialize\n\n";
//     return true;
// } // -- END deserialize
