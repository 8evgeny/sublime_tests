...
namespace devices
{
class GstRtp : public Device
{
public:
    GstRtp(const gst_rtp::UserSettings &settings);
    ~GstRtp();
    void setup() override;
    void start() override;
    void quit() override;
...
private:
    ...
    gst_rtp::UserSettings settings;
    gst_rtp::Settings gen_settings;
