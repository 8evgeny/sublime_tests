...
#ifdef USE_GST_RTP
#include "devices/GstRtp/gst_rtp_factory.hpp"
#endif // USE_GST_RTP
...
private:
    ...
    cv::Mat frame_send;                 // кадр для отправки на RTSPServer
...
//    std::shared_ptr<rtsp::server::RTSPServer> rtsp_srv_ptr = nullptr; //std::make_shared<rtsp::server::RTSPServer>(settings_);
//    rtsp::server::SettingsRtspSrv settings_rtsp_srv;
