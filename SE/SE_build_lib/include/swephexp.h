...
#define SEFLG_SPEED3                                                 \
  128                      /* speed from 3 positions (do not use it, \
...
#define SEFLG_ASTROMETRIC                                                \
  (SEFLG_NOABERR | SEFLG_NOGDEFL)   /* astrometric position,             \
                                     * i.e. with light-time, but without \
...
#define SEFLG_DPSIDEPS_1980              \
  (256 * 1024) /* reproduce JPL Horizons \
                * 1962 - today to 0.002 arcsec. */
#define SEFLG_JPLHOR SEFLG_DPSIDEPS_1980
#define SEFLG_JPLHOR_APPROX \
  (512 * 1024) /* approximate JPL Horizons 1962 - today */
#define SEFLG_CENTER_BODY                                     \
  (1024 * 1024) /* calculate position of center of body (COB) \
                   of planet, not barycenter of its system */
#define SEFLG_TEST_PLMOON                                      \
  (2 * 1024 * 1024 | SEFLG_J2000 | SEFLG_ICRS | SEFLG_HELCTR | \
...
#define SE_MAX_STNAME                      \
  256 /* maximum size of fixstar name;     \
...
#define SE_BIT_FIXED_DISC_SIZE               \
  16384 /* or'ed to SE_CALC_RISE/SET:        \
         * neglect the effect of distance on \
         * disc size */
#define SE_BIT_FORCE_SLOW_METHOD                \
  32768 /* This is only an Astrodienst in-house \
         * test flag. It forces the usage       \
         * of the old, slow calculation of      \
         * risings and settings. */
#define SE_BIT_HINDU_RISING \
...
#define SE_EPHE_PATH                                                     \
  ".:/home/eparubets/Sublime_test/SE/SE_build_lib/eph/:/home/eparubets/" \
  "Sublime_tests/SE/"                                                    \
  "SE_build_lib/eph/"
...
#define SE_SPLIT_DEG_KEEP_SIGN          \
  16 /* don't round to next sign,       \
      * e.g. 29.9999999 will be rounded \
      * to 29d59'59" (or 29d59' or 29d) */
#define SE_SPLIT_DEG_KEEP_DEG           \
  32 /* don't round to next degree      \
...
#define SE_HELFLAG_AVKIND                                                  \
  (SE_HELFLAG_AVKIND_VR | SE_HELFLAG_AVKIND_PTO | SE_HELFLAG_AVKIND_MIN7 | \
...
#define SE_TIDAL_DE421 \
  (-25.85) /* JPL Interoffice Memorandum 14-mar-2008 on DE421 Lunar Orbit */
#define SE_TIDAL_DE422                                                     \
  (-25.85) /* JPL Interoffice Memorandum 14-mar-2008 on DE421 (sic!) Lunar \
              Orbit */
#define SE_TIDAL_DE430 \
  (-25.82) /* JPL Interoffice Memorandum 9-jul-2013 on DE430 Lunar Orbit */
#define SE_TIDAL_DE431                                                     \
  (-25.80) /* IPN Progress Report 42-196 • February 15, 2014, p. 15; was \
              (-25.82) in V. 2.00.00 */
...
#define SEMOD_NUT_IAU_CORR_1987                                           \
...
#define SEMOD_JPLHOR_LONG_AGREEMENT          \
