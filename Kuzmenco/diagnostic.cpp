...
//Или 1 или 2
    ...
    if (((Channel_IG == "C/2")||(Channel_IG == "C/1")||(Channel_IG == "C/0")||(Channel_IG == "C/-1")||(Channel_IG == "C/-2")) &&
        ...
        {
            one_or_two = true;
            diagnosic_message.append("Канал тонк.киш.: (2мд: IG/C+C/C) илио-кардиальный синдром.\n Редкое заболевание: проблемы с сердцем"
                                     " из-за отравленной пищи в тонком кишечнике - нужно убрать интоксикацию.\n Таким людям нужно кушать "
                                     "только проверенную качественную пищу.\n");
        }
    if (one_or_two)
        return;
