...
//Канал легких
    if (((Channel_P == "B/2")||(Channel_P == "B/1")||(Channel_P == "B/0")||(Channel_P == "B/-1")||(Channel_P == "B/-2")) &&
        ...
        {
            diagnosic_message.append("Канал легких: (2мд)Острый ринит, евстахеит, отит.\n");
            return;
        }
    ...
    if (((Channel_P == "A/2")||(Channel_P == "A/1")||(Channel_P == "A/-1")||(Channel_P == "A/-2")) &&
        ((Channel_RP == "A/2")||(Channel_RP == "B/2")||(Channel_RP == "C/2")||(Channel_RP == "A/-2")||(Channel_RP == "B/-2")||(Channel_RP == "C/-2")))
        {
            diagnosic_message.append("Канал легких: (2мд)Острая простуда или острое заболевание органов дыхания.\n");
            return;
        }
    ...
    if (((Channel_P == "C/2")||(Channel_P == "C/1")||(Channel_P == "C/-1")||(Channel_P == "C/-2")||(Channel_P == "C/0")) &&
        ((Channel_RP == "A/2")||(Channel_RP == "B/2")||(Channel_RP == "C/2")||(Channel_RP == "A/-2")||(Channel_RP == "B/-2")||(Channel_RP == "C/-2")))
        {
            diagnosic_message.append("Канал легких: (2мд)Хронические заболевания органов дыхания.\n");
            return;
        }
...
void MainWindow::channel_MC()
{
    ...
    if (((Channel_MC == "A/2")||(Channel_MC == "A/1")) &&
        ...
        {
            diagnosic_message.append("Канал перикарда: (2мд: MC/A/1,2 + RP/ABC/2) Острые заболевания матки или предстательной железы.\n");
            return;
        }
    ...
    if (((Channel_MC == "A/-2")||(Channel_MC == "A/-1")) &&
            ((Channel_RP == "A/2")||(Channel_RP == "B/2")||(Channel_RP == "C/2")))
        {
            diagnosic_message.append("Канал перикарда: (2мд: MC/A/-1,-2 + RP/ABC/2) Стихание симптомов при заболевании матки или предстательной железы, выздоровление.\n");
            return;
        }
...
//Канал перикарда А
    ...
    if (Channel_MC == "OK")
    {
        diagnosic_message.append("Канал перикарда: может быть при эндометритах и простатитах (см дополнительно другие каналы).\n");
    }

//Канал перикарда В
    if (Channel_MC == "B/2")
    {
        diagnosic_message.append("Канал перикарда: повышено систолическое (верхнее) давление; вариант нормы. Нервная система возбуждена (я хочу).\n (конспект): серъезная претензия к людям противоположного пола: привычка обвинять их во всех грехах.\n");
    }
    if (Channel_MC == "B/1")
    {
        diagnosic_message.append("Канал перикарда: норма.\n (конспект): серъезная претензия к людям противоположного пола: привычка обвинять их во всех грехах.\n");
    ...
    if (Channel_MC == "B/-2")
    {
        diagnosic_message.append("Канал перикарда: понижено систолическое (верхнее) давление, гипотония, перед сном (я не хочу); вариант нормы.\n (конспект): серъезная претензия к людям противоположного пола: привычка обвинять их во всех грехах.\n");
    }

//Канал перикарда С
    if (Channel_MC == "C/2")
    {
        diagnosic_message.append("Канал перикарда: есть предвестник/легкие заболевания - сосудов. Гипертония по сосудистому типу (повышены верхние цифры).\n");
    }
    if (Channel_MC == "C/1")
    {
        diagnosic_message.append("Канал перикарда: есть предвестник/легкие заболевания - сосудов. Гипертония по сосудистому типу (повышены верхние цифры).\n");
    ...
    if (Channel_MC == "C/0")
    {
        diagnosic_message.append("Канал перикарда: склонность к спазмам сосудов.\n");
    }
    if (Channel_MC == "C/-1")
    {
    ...
    if (Channel_MC == "OP")
    {
        diagnosic_message.append("Канал перикарда: вероятность опухоли в органах половой системы, или их тяжелое воспаление. Но здесь нужно смотреть сочетания с другими меридианами! (см: TR/C + RP/C/2).\n");
    }
//Закрашиваем треугольники
...
//Канал сердца А
    if (Channel_C == "A/2")
    {
        diagnosic_message.append("Канал сердца: тахикардия, гипертрофия левого желудочка сердца (спазм сосудов по БКК, возможны проблемы с внутр.органами), гипертония; больше физиология и дискомфорт.\n Чем больше расстояние между точками - тем больше гипертрофия.\n");
    }
    if (Channel_C == "A/1")
    {
        diagnosic_message.append("Канал сердца: склонность к тахикардии, гипертрофии левого желудочка сердца, повышению АД; больше физиология и дискомфорт.\n Чем больше расстояние между точками - тем больше гипертрофия.\n");
    }
    if (Channel_C == "A/0")
    {
    ...
    if (Channel_C == "A/-1")
    {
        diagnosic_message.append("Канал сердца: склонность к брадикардии, гипертрофии правого желудочка сердца (вариант нормы: спазм сосудов в МКК; признак проблемы в органах дыхания, а не в сердце; или раньше был спортсменом/танцором/грузчиком), понижению АД.\n Больше физиология и дискомфорт.\n Чем больше расстояние между точками - тем больше гипертрофия.\n");
    }
    if (Channel_C == "A/-2")
    {
        diagnosic_message.append("Канал сердца: брадикардия, гипертрофия правого желудочка сердца (вариант нормы: спазм сосудов в МКК; признак проблемы в органах дыхания: а не в сердце; или раньше был спортсменом/танцором/грузчиком), понижено АД.\n Больше физиология и дискомфорт.\n Чем больше расстояние между точками - тем больше гипертрофия.\n");
    }
    if (Channel_C == "OK")
    {
...
//Канал сердца С
    if (Channel_C == "C/2")
    {
        diagnosic_message.append("Канал сердца: тахикардия, гипертрофия правого желудочка сердца (вариант нормы: спазм сосудов в МКК; признак проблемы в органах дыхания, а не в сердце; или раньше был спортсменом/танцором/грузчиком), повышено АД. Больше эмоции, чем болезнь.\n Чем больше расстояние между точками - тем больше гипертрофия.\n");
    }
    if (Channel_C == "C/1")
    {
        diagnosic_message.append("Канал сердца: тахикардия, гипертония, склонность к гипертрофии правого желудочка сердца (вариант нормы: спазм сосудов в МКК; признак проблемы в органах дыхания, а не в сердце; или раньше был спортсменом/танцором/грузчиком). Больше эмоции, чем болезнь.\n  Чем больше расстояние между точками - тем больше гипертрофия.\n");
    }
    if (Channel_C == "C/0")
    {
        diagnosic_message.append("Канал сердца: норма.\n");
    ...
    if (Channel_C == "C/-1")
    {
        diagnosic_message.append("Канал сердца: брадикардия, гипотония, склонность к гипертрофии левого желудочка сердца (спазм сосудов по БКК, возможны проблемы с внутр.органами).Больше эмоции, чем болезнь.\n Чем больше расстояние между точками - тем больше гипертрофия.\n");
    }
    if (Channel_C == "C/-2")
    {
        diagnosic_message.append("Канал сердца: брадикардия, гипотония, гипертрофия левого желудочка сердца (спазм сосудов по БКК, возможны проблемы с внутр.органами); переходное состояние из гипотонии в гипертонию. Больше эмоции, чем болезнь.\n Чем больше расстояние между точками - тем больше гипертрофия.\n");
    }
    if (Channel_C == "OP")
    {
