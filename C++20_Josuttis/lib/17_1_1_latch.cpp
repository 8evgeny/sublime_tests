...
/*Защелка - это новый механизм синхронизации для параллельного выполнения, поддерживающий одноразовый асинхронный
обратный отсчет. Начиная с начального интегрального значения, различные потоки могут атомарно подсчитывать это значение вплоть до
нуля. В тот момент, когда счетчик достигает нуля, все потоки, ожидающие этого обратного отсчета, продолжаются.*/
