...
struct qt_meta_stringdata_Cloud_t {
    QByteArrayData data[4];
    char stringdata0[20];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Cloud_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Cloud_t qt_meta_stringdata_Cloud = {
    {
QT_MOC_LITERAL(0, 0, 5), // "Cloud"
QT_MOC_LITERAL(1, 6, 7), // "clicked"
QT_MOC_LITERAL(2, 14, 0), // ""
QT_MOC_LITERAL(3, 15, 4) // "bang"

    },
    "Cloud\0clicked\0\0bang"
};
...
void Cloud::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Cloud::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Cloud::clicked)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Cloud::staticMetaObject = { {
    &Block::staticMetaObject,
    qt_meta_stringdata_Cloud.data,
    qt_meta_data_Cloud,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *Cloud::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Cloud.stringdata0))
